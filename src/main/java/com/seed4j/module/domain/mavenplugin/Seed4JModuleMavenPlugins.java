...
public final class Seed4JModuleMavenPlugins {

  private final Collection<MavenPlugin> pluginsManagement;
  private final Collection<MavenPlugin> plugins;

  private Seed4JModuleMavenPlugins(Seed4JModuleMavenPluginsBuilder<?> builder) {
    pluginsManagement = builder.pluginsManagement;
    plugins = builder.plugins;
  }

  public static <T> Seed4JModuleMavenPluginsBuilder<T> builder(T parentModuleBuilder) {
    return new Seed4JModuleMavenPluginsBuilder<>(parentModuleBuilder);
  }
  ...
  public static final class Seed4JModuleMavenPluginsBuilder<T> {
    ...
    private Seed4JModuleMavenPluginsBuilder(T parentModuleBuilder) {
      Assert.notNull("parentModuleBuilder", parentModuleBuilder);

      this.parentModuleBuilder = parentModuleBuilder;
    }

    public Seed4JModuleMavenPluginsBuilder<T> pluginManagement(MavenPlugin pluginManagement) {
    ...
    public Seed4JModuleMavenPluginsBuilder<T> plugin(MavenPlugin plugin) {
    ...
    public Seed4JModuleMavenPlugins build() {
      return new Seed4JModuleMavenPlugins(this);
    }
  }
}
