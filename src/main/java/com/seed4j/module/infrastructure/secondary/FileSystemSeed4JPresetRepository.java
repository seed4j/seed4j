...
import com.seed4j.module.domain.Seed4JPresetRepository;
...
@Repository
class FileSystemSeed4JPresetRepository implements Seed4JPresetRepository {
  ...
  public FileSystemSeed4JPresetRepository(
    ObjectMapper json,
