...
public record AnnotationWithDoubleValueImpl(String name, Optional<String> value1, Optional<String> value2, Optional<ClassImport> import_)
  implements Annotation {
  public AnnotationWithDoubleValueImpl {
