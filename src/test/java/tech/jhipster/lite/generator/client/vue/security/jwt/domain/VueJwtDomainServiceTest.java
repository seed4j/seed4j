...
import static tech.jhipster.lite.TestUtils.tmpProjectWithPiniaAndAppContext;
...
class VueJwtDomainServiceTest {
  ...
  void shouldAddVueJwt() {
    Project project = tmpProjectWithPiniaAndAppContext();
  ...
  @Test
  void shouldNotWriteToAppContext() {
