...
class MavenProjectJavaDependenciesRepositoryTest {
  ...
  void shouldNotReadFromUnreadableMavenFile() {
    assertThatThrownBy(() ->
      projectDependencies.get(new Seed4JProjectFolder("src/test/resources/projects/maven-unreadable"))
    ).isExactlyInstanceOf(GeneratorException.class);
  }

  @Test
  void shouldGetEmptyDependenciesFromEmptyProject() {
    assertThat(projectDependencies.get(new Seed4JProjectFolder("src/test/resources/projects/empty"))).isEqualTo(
  ...
  void shouldGetEmptyProjectDependenciesFromEmptyMavenFile() {
    assertThat(projectDependencies.get(new Seed4JProjectFolder("src/test/resources/projects/empty-maven")))
