Feature: Spring Kafka

  Scenario: Should apply Spring Kafka init module
  ...
  Scenario: Should apply Spring Kafka sample producer consumer module
    When I apply "spring-boot-spring-kafka-sample-producer-consumer" module to default project with maven file
  ...
  Scenario: Should apply Spring Kafka AKHQ module
    When I apply "spring-boot-spring-kafka-akhq" module to default project with maven file
      | packageName | com.seed4j.growth |
      | baseName    | growth            |
    Then I should have files in "src/main/docker"
      | akhq.yml |
