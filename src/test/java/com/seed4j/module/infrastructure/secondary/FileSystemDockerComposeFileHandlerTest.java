...
public class FileSystemDockerComposeFileHandlerTest {
  ...
  void shouldCreateDefaultRootDockerComposeFileForProjectWithoutIntegration() {
    ...
    handler.handle(Indentation.DEFAULT, new Seed4JProjectFolder(folder), dockerComposeFile(redisDockerComposeFileReference()));
  ...
  void shouldUpdateRootDockerComposeFile() {
    ...
    handler.handle(Indentation.DEFAULT, new Seed4JProjectFolder(folder), dockerComposeFile(kafkaDockerComposeFileReference()));
