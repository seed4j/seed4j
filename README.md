...
This project is a fork of the original [JHipster Lite](https://github.com/jhipster/jhipster-lite), now maintained under the **Seed4J** organization. It will be developed and maintained by the original authors of JHipster Lite project.
