...
@Repository
class Seed4JJavaDependenciesVersionsRepository implements JavaDependenciesVersionsRepository {

  private final Supplier<JavaDependenciesVersions> versions;

  public Seed4JJavaDependenciesVersionsRepository(Collection<JavaDependenciesReader> readers) {
