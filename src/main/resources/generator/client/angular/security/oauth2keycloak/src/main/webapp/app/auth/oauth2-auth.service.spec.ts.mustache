  ...
  beforeEach(() => {
    ...
    service = Injector.create({
      providers: [
        {
          provide: Keycloak,
          useValue: keycloakInstance,
        },
        Oauth2AuthService,
      ],
    }).get(Oauth2AuthService);
