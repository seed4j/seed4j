  ...
  public Seed4JModule buildModule(Seed4JModuleProperties properties) {
    ...
    return moduleBuilder(properties)
      .javaDependencies()
        ...
        .addDependency(SPRING_CLOUD_GROUP, artifactId("spring-cloud-starter-gateway-server-webflux"))
        .and()
      ...
      .files()
        .batch(SOURCE, destination)
          .addTemplate("GatewayResource.java")
          .addTemplate("RestRoute.java")
          .addTemplate("RestServiceInstance.java")
        .and()
