...
public class EurekaModuleFactory {
  ...
  private static final Seed4JSource SPRING_CLOUD_SOURCE = from("server/springboot/springcloud/configclient");
  private static final Seed4JSource EUREKA_SOURCE = from("server/springboot/springcloud/eureka");
