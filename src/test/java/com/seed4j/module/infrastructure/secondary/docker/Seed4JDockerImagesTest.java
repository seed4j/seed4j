...
@UnitTest
class Seed4JDockerImagesTest {

  @Test
  void shouldNotReadImageWithoutReaders() {
    Seed4JDockerImages images = new Seed4JDockerImages(List.of());
  ...
  void shouldNotReadUnknownImage() {
    Seed4JDockerImages images = new Seed4JDockerImages(List.of(emptyReader()));
  ...
  void shouldGetFirstKnownImage() {
    ...
    Seed4JDockerImages images = new Seed4JDockerImages(List.of(emptyReader(), firstReader, secondReader));
